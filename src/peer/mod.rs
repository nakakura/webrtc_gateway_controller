...
mod test_create_peer {
    ...
    /// http://35.200.46.204/#/1.peers/peer
    #[tokio::test]
    async fn test_create_peer_connected_to_another_webserver() {
        let peer_id = "hoge";
    ...
    /// http://35.200.46.204/#/1.peers/peer
    #[tokio::test]
    async fn test_create_peer_connected_to_another_version() {
        let peer_id = "hoge";
        let token = "test-token";
    ...
    #[tokio::test]
    async fn test_create_peer_without_server() {
        let peer_id = "hoge";
...
mod test_listen_event {
    ...
    /// http://35.200.46.204/#/1.peers/peer
    #[tokio::test]
    async fn test_listen_event_200_recv_open() {
        let peer_id = "hoge";
        let token = "test-token";
    ...
    /// http://35.200.46.204/#/1.peers/peer
    #[tokio::test]
    async fn test_listen_event_200_recv_connection() {
        let peer_id = "hoge";
        let token = "test-token";
    ...
    /// http://35.200.46.204/#/1.peers/peer
    #[tokio::test]
    async fn test_listen_event_200_recv_call() {
        let peer_id = "hoge";
        let token = "test-token";
    ...
    /// http://35.200.46.204/#/1.peers/peer
    #[tokio::test]
    async fn test_listen_event_200_recv_close() {
        let peer_id = "hoge";
        let token = "test-token";
    ...
    /// http://35.200.46.204/#/1.peers/peer
    #[tokio::test]
    async fn test_listen_event_200_recv_error() {
        let peer_id = "hoge";
        let token = "test-token";
    ...
    /// http://35.200.46.204/#/1.peers/peer
    #[tokio::test]
    async fn test_listen_event_200_but_recv_invalid_json() {
        let peer_id = "hoge";
        let token = "test-token";
